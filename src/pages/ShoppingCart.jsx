...
const ShoppingCart = () => {
  ...
  return (
  <>
{isEmpty?<div className='d-flex justify-content-center w-100'><img src='https://cdn.dribbble.com/users/461802/screenshots/4421003/emptycart.gif'/></div>:<div className='container-fluid my-5'>
